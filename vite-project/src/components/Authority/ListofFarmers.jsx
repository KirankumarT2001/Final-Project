...
const ListofCustomers = () => {
  ...
  const users = useSelector(state => state.addContract.users);

  const handleApproval = async (ETHAddress) => {
    await users.deleteCrop(ETHAddress);
    await users.deleteMidterm(ETHAddress);
    await users.deleteCertificate(ETHAddress);
